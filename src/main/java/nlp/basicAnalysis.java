...
public class basicAnalysis {
	...
	static org.slf4j.Logger logger =  LoggerFactory.getLogger(basic.class);
	public static void runBasicAnalysis() {
...
//        System.out.println(nerTags);
     ...
     // creates a StanfordCoreNLP object, with POS tagging, lemmatization, NER, parsing, and
        ...
        for (String s : tests) {
          ...
          logger.debug("We extracted {} tokens of interest from the input text", tokens.size());
        }
	}
        private static void handleEntity(String inKey, StringBuilder inSb, List inTokens) {
            logger.info("'{}' is a {}", inSb, inKey);
